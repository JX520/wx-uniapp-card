<template>
	<view>
		<view class="wm-numbox">
			<view :class="['wm-numbox_btn',model==2?'wm-numbox_radio_m':'wm-numbox_minus',inputValue <= min?'numbox_disabled':'']" :style="{width:height+'px',height:height+'px',lineHeight:height-5+'px',fontSize:height-3+'px'}" @click="Minus">-</view>
