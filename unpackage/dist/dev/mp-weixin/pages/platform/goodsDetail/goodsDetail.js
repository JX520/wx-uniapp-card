...
var _goodsDetail = _interopRequireDefault(__webpack_require__(/*! ./pages/platform/goodsDetail/goodsDetail.vue */ 188));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _goodsDetail_vue_vue_type_template_id_3022bd3b_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./goodsDetail.vue?vue&type=template&id=3022bd3b&scoped=true& */ 189);
/* harmony import */ var _goodsDetail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./goodsDetail.vue?vue&type=script&lang=js& */ 191);
...
/* harmony import */ var _goodsDetail_vue_vue_type_style_index_0_id_3022bd3b_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./goodsDetail.vue?vue&type=style&index=0&id=3022bd3b&lang=scss&scoped=true& */ 193);
...
var components = {
  ...
  "u-divider": function() {
    return __webpack_require__.e(/*! import() | uview-ui/components/u-divider/u-divider */ "uview-ui/components/u-divider/u-divider").then(__webpack_require__.bind(null, /*! @/uview-ui/components/u-divider/u-divider.vue */ 315))
  },
  "u-icon": function() {
  ...
  methods: {
    ...
    getGoods: function getGoods(gid) {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var res, arr, i;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                ...
                for (i in _this.goods) {
                  _this.goods[i].goods.find(function (item) {
                    arr.push(item);
                  });
                }
                _this.detail = arr.find(function (one) {
                  return one['gid'] == gid;
                });
